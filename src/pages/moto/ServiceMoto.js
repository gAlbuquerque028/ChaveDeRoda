...
export default function MotoCategory() {
  const navigation = useNavigation();

  // const [service, getService] = useState('');

  const alinhamentoService = () => {
    navigation.navigate('AlinhamentoMoto')
  }

  const balanceamentoService = () => {
    navigation.navigate('BalanceamentoMoto')
  }

  const revisaoService = () => {
    navigation.navigate('RevisaoMoto')
  }

  const trocaOleoService = () => {
    navigation.navigate('TrocaOleoMoto')
  }
