...
import { Image, Text, TextInput ,StyleSheet, View, TouchableOpacity, SafeAreaView, Modal } from 'react-native';
    ...
    return (
      <View style={styles.boxContainer}>
        <View style={styles.box}>
          ...
          <TouchableOpacity onPress={FeedbackText} style={{ width: '100%', height: 40, borderColor: 'black', borderWidth:1, borderRadius: 10, alignItems: 'center', justifyContent: 'center', marginTop: 4, }}>
                <Text style={{ fontSize: 25 }}>Novo Feedback</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
