    ...
    return (
      <View style={styles.boxContainer}>
        <View style={styles.box}>
          <TouchableOpacity onPress={() => create(getService('Alinhamento'))}>
            <Alinhamento />
          </TouchableOpacity>
        </View>

        <View style={styles.box}>
          <TouchableOpacity onPress={() => create(getService('Balanceamento'))}>
            <Balanceamento />
          </TouchableOpacity>
        </View>

        <View style={styles.box}>
          <TouchableOpacity onPress={() => create(getService('Revisão'))}>
            <Revisao />
          </TouchableOpacity>
        </View>

        <View style={styles.box}>
          <TouchableOpacity onPress={() => create(getService('Troca de Oleo'))}>
            <TrocaOleo />
          </TouchableOpacity>
        </View>
      </View>
