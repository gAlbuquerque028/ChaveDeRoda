...
export default function VanCategory() {
  const navigation = useNavigation();

  // const [service, getService] = useState('');

  const alinhamentoService = () => {
    navigation.navigate('AlinhamentoVan')
  }

  const balanceamentoService = () => {
    navigation.navigate('BalanceamentoVan')
  }

  const revisaoService = () => {
    navigation.navigate('RevisaoVan')
  }

  const trocaOleoService = () => {
    navigation.navigate('TrocaOleoVan')
  }
