...
export default function CarroCategory() {
  const navigation = useNavigation();

  // const [service, getService] = useState('');

  const alinhamentoService = () => {
    navigation.navigate('AlinhamentoCarro')
  }

  const balanceamentoService = () => {
    navigation.navigate('BalanceamentoCarro')
  }

  const revisaoService = () => {
    navigation.navigate('RevisaoCarro')
  }

  const trocaOleoService = () => {
    navigation.navigate('TrocaOleoCarro')
  }
